...
// Read from text file
// Read JSON's file - Classical Songs
...
<body>
    ...
    <div class="main_back">
        ...
        <div class="title_name">Let's PIANO</div>
        <!-- Piano Sheet Part -->
        ...
        <div class="svg_back">
            <div class="svg_frame_style">
                <div class="svg">
                    <!-- Library for Music -->
                    <!-- SVG では、後で再利用できるよう描画オブジェクトを定義します。 -->
                  <svg>
                  <!-- 参照される要素は、可能なかぎりdefs要素内で定義されることが推奨されています。 -->
                    ...
                    <g transform="translate(0,60)" id="grand-staff">
                      ...
                      <use id="main_clef" xlink:href="#g-clef" x="20" y="60"></use>
                      <g id="notes" transform="translate(120,100)">
                        <!-- Sample of writing a music sheet in below -->
